...
export class BeyondPresence {
  ...
  constructor({
    ...
    this.logLevel = parseLogLevel(options.logLevel, 'ClientOptions.logLevel', this) ?? parseLogLevel(readEnv('BEYOND_PRESENCE_LOG'), 'process.env[\'BEYOND_PRESENCE_LOG\']', this) ?? defaultLogLevel;
