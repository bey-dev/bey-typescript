...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bey.dev//v1/auth/verify \\\n    -H \"x-api-key: $BEY_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ data: { id: string; agent_id: string; status: { type?: 'to_start'; } | { started_at: string; type?: 'ongoing'; } | { ended_at: string; started_at: string; type?: 'completed'; }; tags?: object; }[]; next_cursor: string; has_more?: true; } | { data: { id: string; agent_id: string; status: { type?: 'to_start'; } | { started_at: string; type?: 'ongoing'; } | { ended_at: string; started_at: string; type?: 'completed'; }; tags?: object; }[]; has_more?: false; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bey.dev//v1/calls \\\n    -H \"x-api-key: $BEY_API_KEY\""
      }
    }
  }
];
