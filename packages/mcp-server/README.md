...
```sh
git clone git@github.com:bey-dev/bey-typescript.git
cd bey-typescript
./scripts/bootstrap
./scripts/build
```
...
> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npx -y bey-mcp`
